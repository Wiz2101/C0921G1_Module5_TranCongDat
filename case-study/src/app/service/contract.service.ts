...
export class ContractService {
  public contractList: Contract[] = [
    new Contract(1, 'CT-0001', new Customer(1, 'KH-0001', 'Nguyen Van An', '2000-12-12', 1, '205123123', '0912412123', 'annguyen@gmail.com', new CustomerType(3, 'Gold'), 'Da Nang'), new Facility(1, 'Ocean Suite', '85.5', 4500000, '2', new RentType(1, 'Day'), new AttachService(1, 'Massage', 'Hour', 450000), '2022-03-07', '2022-03-09', 5000000), '2022-04-09', '2022-04-10', 2000000),
    ...
    new Contract(4, 'CT-0004', new Customer(1, 'KH-0004', 'Nguyen Van An', '2000-12-12', 1, '205123123', '0912412123', 'annguyen@gmail.com', new CustomerType(3, 'Gold'), 'Da Nang'), new Facility(6, 'Garden Deluxe', '43.7', 3500000, '2', new RentType(1, 'Day'), new AttachService(1, 'Massage', 'Hour', 450000), '2022-03-07', '2022-03-09', 5000000), '2022-03-07', '2022-03-09', 2500000),
    new Contract(5, 'CT-0005', new Customer(4, 'KH-0005', 'Bui Cong Danh', '1998-02-28', 1, '201821231', '0912012721', 'danhbui@gmail.com', new CustomerType(3, 'Gold'), 'Hue'), new Facility(3, 'Ocean Deluxe', '43.7', 3500000, '2', new RentType(1, 'Day'), new AttachService(1, 'Massage', 'Hour', 450000), '2022-03-07', '2022-03-09', 5000000), '2022-05-07', '2022-05-08', 3000000)
  ];
